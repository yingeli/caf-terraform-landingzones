...
module "aks_region2" {
    ...
    prefix                      = local.prefix
    resource_groups             = var.aks_resource_groups.region2
    object                      = var.aks_object.region2
    networking                  = var.aks_networking.region2
    identity                    = var.aks_identity.region2
    waf_configuration           = var.waf_configuration.region2
